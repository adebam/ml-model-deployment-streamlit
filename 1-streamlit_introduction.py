...
st.markdown("###### This is another smaller heading")
...
if button:
    ...
    st.toast("I am dissappear")
    st.warning("This is warning")
    st.error("This is error")

# Image
st.image("https://images.pexels.com/photos/674010/pexels-photo-674010.jpeg?cs=srgb&dl=pexels-anjana-c-169994-674010.jpg", width=400)
